  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
       <li><a href="main.html" target="main"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>LOGOUT</a></li>
...
$sql="select seats from busdetails1 where name='$name'";
$result=$con->query($sql);
if($row=$result->fetch_assoc()){
  $change=$row['seats']-$number;
  // echo "$change";
  $sql1="update busdetails1 set seats='$change' where name='$name'";
  if($con->query($sql1)){
    echo "<html>";
    echo "<body>";
    ...
    echo "<tr>";
    echo "<td>YOUR PAYMENT HAS BEEN SUCCESSFULLY COMPLETED</td></tr>";
    echo "<tr><td>WE HOPE YOU WILL HAVE A GOOD TIME</td></tr>";
    echo "<tr><td>FOR ANY HELP CONTACT US:9999999989</tr></td>";
