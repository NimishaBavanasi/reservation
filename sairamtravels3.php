...
{   var n=selected_seats.length;
	...
	{
		var amount=n*600;
	    document.writeln("<html><head><link rel=stylesheet type=text/css href=back.css/></head><body bgcolor=skyblue><center><h2>SEAT DETAILS AND PAYMENT</h2><table border=2><th>No of seats booked</th><th>Amount for the tickets</th><tr class=even><td name=bookedseats>"+n+"</td><td>"+amount+"</td></tr></table><br><br><a href=payment1.php><input type=button name=b value=PROCEED></a></form></center></body></html>");
	}
}
